...
export default function Home() {
  return (
    ...
    items-center justify-center min-h-screen px-8 pb-20 
    gap-16 sm:px-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 
      justify-center items-center sm:items-center text-center">

        <div className="border-6 border-foreground 
        border-double overflow-hidden h-59 w-54 "
          style={{ display: 'flex' }}
        >
          <Image
